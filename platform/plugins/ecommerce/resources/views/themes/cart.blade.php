                    ...
                    <div class="card p-4">
                        ...
                        {{-- @if(session('currency_data') == 'INR')
                            @php
                                ...
                                $certificate_charge = config('plugins.ecommerce.general.certificate_charge.India');
                            @endphp
                        @else
                            @php
                                $making_charges = config('plugins.ecommerce.general.making_charge.Out_of_india');
                                $certificate_charge = config('plugins.ecommerce.general.certificate_charge.Out_of_india');
                            @endphp
                        @endif
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <span>{{ __('Certificate Charge') }}</span>
                            @if(session('currency_data') == 'INR')
                            <span data-bb-value="cart-promotion-discount-amount">{{ format_price($certificate_charge) }}</span>
                            @else
